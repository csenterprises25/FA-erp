...
4. Before enabling automated deployments, upload the `install` directory once
   and run the FrontAccounting installer to create `config.php`, `config_db.php`,
   the database schema, and the first administrator. The workflow intentionally
   does not upload the installer.
